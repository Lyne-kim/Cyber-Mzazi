...
TRANSLATIONS = {
    "sw": {
        ...
        "Parent denied sign-out": "Mzazi amekataa kutoka",
        "Logout denied. The child session remains active.": "Kutoka kumekataliwa. Kikao cha mtoto kinaendelea kuwa wazi.",
